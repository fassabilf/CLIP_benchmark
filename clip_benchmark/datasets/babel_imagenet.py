...
Patched to use ImageFolder so it doesn't require ILSVRC2012_devkit_t12.tar.gz —
val/ already organized into class subdirs is sufficient.
"""
class BabelImageNet(torchvision.datasets.ImageFolder):
