...
#SBATCH -t 03:00:00
#SBATCH -A lt200394
#SBATCH -J cb_sweep_mc2v3_${SLURM_ARRAY_TASK_ID}
#SBATCH -a 1-4
...
# Full eval suite for Habibi's metaclip2_kd v3 run = "CC12M + SEA blend": ViT-T-16 student
# distilled from MetaCLIP2-ViT-B-16-worldwide, trained on CC12M (~10.97M EN pairs) concatenated
# with the full SEA multilingual blend (CG-OE-filt × 6 langs + WIT-hf-base × 6 langs + Bloom,
# ~1.21M pairs). Same student init / teacher / loss (clipkd) as v1 & v2.
...
case "$SLURM_ARRAY_TASK_ID" in
    1) TAG="mc2v3_e8";  MODEL="ViT-T-16"; CKPT="$MC2V3_E8_CKPT" ;;
    2) TAG="mc2v3_e16"; MODEL="ViT-T-16"; CKPT="$MC2V3_E16_CKPT" ;;
    3) TAG="mc2v3_e24"; MODEL="ViT-T-16"; CKPT="$MC2V3_E24_CKPT" ;;
    4) TAG="mc2v3_e32"; MODEL="ViT-T-16"; CKPT="$MC2V3_E32_CKPT" ;;
