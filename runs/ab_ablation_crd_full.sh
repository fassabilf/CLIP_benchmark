...
MODEL="ViT-T-16"
ABLATION_DIR="TODO: fill in checkpoint dir for CRD-only ablation"
...
eval_epoch() {
    ...
    local TAG="ablation_crd_e${EPOCH}"
...
for EP in 8 16 24 32; do
    echo "  python3 runs/compute_per_lang_mean.py ablation_crd_e${EP}"
done
