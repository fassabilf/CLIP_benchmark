#!/bin/bash
# Phase B: run retrieval_from_emb_safe.py for ALL epochs of clipkd_mammoth_only_v6.
# Run on login/transfer node after aj_clipkd_mammoth_only_v6_enc_probe.sh finishes.
#
# Usage:
#   bash runs/aj_clipkd_mammoth_only_v6_retrieval_probe.sh
# Monitor:
#   tail -f nohup_retrieval_clipkd_mammoth_only_v6.out
...
DRIVER_LOG="$(pwd)/nohup_retrieval_clipkd_mammoth_only_v6.out"
