...
#SBATCH -t 03:00:00
#SBATCH -A lt200394
#SBATCH -J ckdonly_v1_${SLURM_ARRAY_TASK_ID}
#SBATCH -a 1-4
...
case "$SLURM_ARRAY_TASK_ID" in
    ...
    2) TAG="ckdonly_v1_e16"; MODEL="ViT-T-16"; CKPT="$CKDONLY_V1_E16_CKPT" ;;
    3) TAG="ckdonly_v1_e24"; MODEL="ViT-T-16"; CKPT="$CKDONLY_V1_E24_CKPT" ;;
    4) TAG="ckdonly_v1_e32"; MODEL="ViT-T-16"; CKPT="$CKDONLY_V1_E32_CKPT" ;;
