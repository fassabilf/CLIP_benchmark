#!/bin/bash
# Commit and push clipkd_mammoth_only_v6 eval results to GitHub.
...
git add \
    runs/results/clipkd_mammoth_only_v6_e8/ \
    runs/results/clipkd_mammoth_only_v6_e16/ \
    runs/results/clipkd_mammoth_only_v6_e24/ \
    runs/results/clipkd_mammoth_only_v6_e32/

git commit -m "add clipkd_mammoth_only_v6 eval results (e8/16/24/32, all benchmarks)"
