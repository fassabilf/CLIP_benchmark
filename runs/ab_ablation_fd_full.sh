...
MODEL="ViT-T-16"
ABLATION_DIR="TODO: fill in checkpoint dir for FD (MSE)-only ablation"
...
for EP in 8 16 24 32; do
    echo "  python3 runs/compute_per_lang_mean.py ablation_fd_e${EP}"
done
