#!/bin/bash
# Phase B: run retrieval_from_emb_safe.py for ALL epochs of ckdonly_v1.
# Run on login/transfer node after ah_ckdonly_v1_enc_probe.sh finishes.
#
# Usage:
#   bash runs/ah_ckdonly_v1_retrieval_probe.sh
# Monitor:
#   tail -f nohup_retrieval_ckdonly_v1.out
...
DRIVER_LOG="$(pwd)/nohup_retrieval_ckdonly_v1.out"
