...
MODEL="ViT-T-16"
ABLATION_DIR="TODO: fill in checkpoint dir for ICL-only ablation"
...
eval_epoch() {
    ...
    local TAG="ablation_icl_e${EPOCH}"
...
for EP in 8 16 24 32; do
    echo "  python3 runs/compute_per_lang_mean.py ablation_icl_e${EP}"
done
