...
#SBATCH -t 03:00:00
#SBATCH -A lt200394
#SBATCH -J clipkd_mammoth_${SLURM_ARRAY_TASK_ID}
#SBATCH -a 1-4
...
# the true metaclip2_kd family) -> size mismatch on token_embedding.weight.
...
case "$SLURM_ARRAY_TASK_ID" in
    1) TAG="clipkd_mammoth_v1_e8";  MODEL="ViT-T-16"; CKPT="$MAMMOTH_KD_E8_CKPT" ;;
    2) TAG="clipkd_mammoth_v1_e16"; MODEL="ViT-T-16"; CKPT="$MAMMOTH_KD_E16_CKPT" ;;
    3) TAG="clipkd_mammoth_v1_e24"; MODEL="ViT-T-16"; CKPT="$MAMMOTH_KD_E24_CKPT" ;;
    4) TAG="clipkd_mammoth_v1_e32"; MODEL="ViT-T-16"; CKPT="$MAMMOTH_KD_E32_CKPT" ;;
