#!/bin/bash
# Phase B: run retrieval_from_emb_safe.py for ALL epochs of clipkd_mammoth_bpe_v1.
# Run on login/transfer node after ai_clipkd_mammoth_bpe_v1_enc_probe.sh finishes.
#
# Usage:
#   bash runs/ai_clipkd_mammoth_bpe_v1_retrieval_probe.sh
# Monitor:
#   tail -f nohup_retrieval_clipkd_mammoth_bpe_v1.out
...
DRIVER_LOG="$(pwd)/nohup_retrieval_clipkd_mammoth_bpe_v1.out"
