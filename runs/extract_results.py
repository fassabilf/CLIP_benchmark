...
COL = {
    ...
    # Habibi metaclip2_kd v2 run: ViT-T-16 (CLIP-BPE) <- MetaCLIP2-B16-worldwide, CC12M baseline.
    "mc2cc_e8":  "vit-t-16-clipkd-metaclip2-b16-cc12m-lr2e-3-e8",
    "mc2cc_e16": "vit-t-16-clipkd-metaclip2-b16-cc12m-lr2e-3-e16",
    "mc2cc_e24": "vit-t-16-clipkd-metaclip2-b16-cc12m-lr2e-3-e24",
    "mc2cc_e32": "vit-t-16-clipkd-metaclip2-b16-cc12m-lr2e-3-e32",
    # Habibi metaclip2_kd v2 single-dataset runs (Jun 2026): random init, one dataset each.
    "mc2wit_e8":    "vit-t-16-clipkd-metaclip2-b16-wit-randinit-lr2e-3-e8",
    "mc2wit_e16":   "vit-t-16-clipkd-metaclip2-b16-wit-randinit-lr2e-3-e16",
    "mc2wit_e24":   "vit-t-16-clipkd-metaclip2-b16-wit-randinit-lr2e-3-e24",
    "mc2wit_e32":   "vit-t-16-clipkd-metaclip2-b16-wit-randinit-lr2e-3-e32",
    "mc2cg_e8":     "vit-t-16-clipkd-metaclip2-b16-cg-randinit-lr2e-3-e8",
