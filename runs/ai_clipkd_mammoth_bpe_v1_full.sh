...
#SBATCH -t 03:00:00
#SBATCH -A lt200394
#SBATCH -J clipkd_mammoth_bpe_v1_${SLURM_ARRAY_TASK_ID}
#SBATCH -a 1-4
...
# Full eval suite for Habibi's clipkd_mammoth_bpe_v1 run ("Alldata"): ViT-T-16 student distilled
# (clipkd loss) from MetaCLIP2-ViT-B-16-worldwide, trained on CC12M + full SEA multilingual blend
# + mammoth_vl_sea, 32ep.
...
case "$SLURM_ARRAY_TASK_ID" in
    1) TAG="clipkd_mammoth_bpe_v1_e8";  MODEL="ViT-T-16"; CKPT="$CLIPKD_MAMMOTH_BPE_V1_E8_CKPT" ;;
    2) TAG="clipkd_mammoth_bpe_v1_e16"; MODEL="ViT-T-16"; CKPT="$CLIPKD_MAMMOTH_BPE_V1_E16_CKPT" ;;
    3) TAG="clipkd_mammoth_bpe_v1_e24"; MODEL="ViT-T-16"; CKPT="$CLIPKD_MAMMOTH_BPE_V1_E24_CKPT" ;;
    4) TAG="clipkd_mammoth_bpe_v1_e32"; MODEL="ViT-T-16"; CKPT="$CLIPKD_MAMMOTH_BPE_V1_E32_CKPT" ;;
